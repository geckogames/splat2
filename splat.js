...
(function() {
  var ImageItem, Item, Screen, alphaThreshold, canvas, credits, ctx, downness, dt, eggo, fps, frame, helpers, keys, keysdown, last, mindown, now, render, screen, screens, step, update, version,
  ...
  canvas.onmouseup = function(e) {
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (i.click) {
        coords = helpers.toCanvasTerms(i.x, i.y, i.image.height);
        if (helpers.getImageAlpha(i.image, e.clientX - coords.x, e.clientY - coords.y) > alphaThreshold) {
