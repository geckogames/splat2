...
(function() {
  var ImageItem, Item, alphaThreshold, canvas, credits, ctx, dimensions, downness, dt, eggo, fps, frame, getImageAlpha, keyStatus, keys, keysdown, last, mindown, now, render, screen, screens, step, timestamp, toCanvasTerms, update, version,
  ...
  update = function() {
    var i, j, k, len, len1, ref, results;
